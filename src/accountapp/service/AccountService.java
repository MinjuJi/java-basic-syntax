package accountapp.service;

import accountapp.domain.Account;
import accountapp.domain.AccountRepository;
...
public class AccountService {
    ...
    /**
     * 지정된 계좌번호에 해당하는 꼐좌정보를 반환한다.
     *
     * @param accNo 조회할 계좌번호
     * @return 계좌정보, null값인 경우도 있다.
     */
    ...
    /**
     * 신규 계좌정보를 전달받아서 계좌를 개설한다.
     * 단, 동일한 계좌번호로 계좌를 개설할 수 없다.
     *
     * @param account 신규 계좌정보
     * @return 계좌개설이 완료되면 true를 반환한다.
     */
    ...
    /**
     * 지정된 계좌번호에 입급액만큼 입급시킨다.
     * 단, 계좌번호에 해당하는 계좌정보가 없으면 입금할 수 없다.
     *
     * @param accNo  계좌번호
     * @param amount 입금액
     * @return 입급이 완료되면 true를 반환한다.
     */
    ...
    /**
     * 지정된 계좌의 비밀번호를 변경한다.
     * 단, 이전 비밀번호와 새 비밀번호가 일치하면 변경할 수 없다.
     * 단, 계좌번호에 해당하는 계좌정보가 존재하지 않으면 변경할 수 없다.
     * 단, 계좌 비밀번호와 이전 비밀번호가 일치하지 않으면 변경할 수 없다.
     *
     * @param accNo  계좌번호
    ...
    /**
     * 지정된 계좌정보를 폐기한다.
     * 단, 계좌번호에 해당하는 계좌정보가 존재하지 않으면 폐기할 수 없다.
